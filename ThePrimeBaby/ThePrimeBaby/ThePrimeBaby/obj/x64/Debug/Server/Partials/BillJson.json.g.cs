...
#line 16 "Server\Partials\BillJson.json"
    get {
#line hidden
...
#line default
    ...
    public class BillsElementJson : __Json__ {
        ...
        private System.Int64 __bf__QUANT_TOTAL__;
        #line default
        ...
        public static class JsonByExample {
            ...
            public class Schema : __TObject__ {
                public Schema()
                    ...
                    QUANT_TOTAL = Add<__TLong__>("QUANT_TOTAL");
                    QUANT_TOTAL.DefaultValue = 0L;
                    QUANT_TOTAL.SetCustomAccessors((_p_) => { return ((__BiBillsEle__)_p_).__bf__QUANT_TOTAL__; }, (_p_, _v_) => { ((__BiBillsEle__)_p_).__bf__QUANT_TOTAL__ = (System.Int64)_v_; }, false);
                }
...
#line default
        ...
        [_GEN1_][_GEN2_("Starcounter","2.0")]
        public __BBiCUSTOMER__ CUSTOMER {
#line 8 "Server\Partials\BillJson.json"
    get {
#line hidden
        return (__BBiCUSTOMER__)Template.CUSTOMER.Getter(this); }
#line 8 "Server\Partials\BillJson.json"
    set {
#line hidden
...
#line default
        ...
        [_GEN1_][_GEN2_("Starcounter","2.0")]
        public System.Int64 QUANT_TOTAL {
#line 15 "Server\Partials\BillJson.json"
    get {
#line hidden
        return Template.QUANT_TOTAL.Getter(this); }
#line 15 "Server\Partials\BillJson.json"
    set {
#line hidden
        Template.QUANT_TOTAL.Setter(this, value); } }
#line default
        ...
        public class CUSTOMERJson : __Json__ {
            #line hidden
            [_GEN2_("Starcounter","2.0")]
            public static __BBCUSchema__ DefaultTemplate = new __BBCUSchema__();
            [_GEN1_][_GEN2_("Starcounter","2.0")]
            public CUSTOMERJson() { }
            [_GEN1_][_GEN2_("Starcounter","2.0")]
            public CUSTOMERJson(__BBCUSchema__ template) { Template = template; }
            [_GEN1_][_GEN2_("Starcounter","2.0")]
            protected override _ScTemplate_ GetDefaultTemplate() { return DefaultTemplate; }
            [_GEN1_][_GEN2_("Starcounter","2.0")]
            ...
            public static class JsonByExample {
                ...
                public class Schema : __TObject__ {
                    public Schema()
                        : base() {
                        InstanceType = typeof(__BBiCUSTOMER__);
...
#line default
            ...
            public static class Input {
                ...
                #line hidden
                [_GEN1_][_GEN2_("Starcounter","2.0")]
                public class ID : Input<__BBiCUSTOMER__, __TLong__, long> {
                }
                #line default
        ...
        public static class Input {
            ...
            #line hidden
            public class QUANT_TOTAL : Input<__BiBillsEle__, __TLong__, long> {
            }
            #line default
        }
        #line default
