...
using __VVeVendorJs__ = global::VendorVoucherJson.VendorVouchersElementJson.VendorJson;
...
using __VVeDATED__ = global::VendorVoucherJson.VendorVouchersElementJson.Input.DATED;
using __VVeVENDOR_B__ = global::VendorVoucherJson.VendorVouchersElementJson.Input.VENDOR_BALANCE;
...
using __VVVeNAME__ = global::VendorVoucherJson.VendorVouchersElementJson.VendorJson.Input.NAME;
using __VVVeID__ = global::VendorVoucherJson.VendorVouchersElementJson.VendorJson.Input.ID;
using __VVeVendorJs2__ = global::VendorVoucherJson.VendorVouchersElementJson.VendorJson.Input;
using __VVeVendorJs1__ = global::VendorVoucherJson.VendorVouchersElementJson.VendorJson.JsonByExample;
...
using __VVVeSchema__ = global::VendorVoucherJson.VendorVouchersElementJson.VendorJson.JsonByExample.Schema;
...
#line 13 "Server\Partials\VendorVoucherJson.json"
    get {
#line hidden
...
#line default
    ...
    public class VendorVouchersElementJson : __Json__ {
        ...
        private __VVeVendorJs__ __bf__Vendor__;
        ...
        public static class JsonByExample {
            ...
            public class Schema : __TObject__ {
                public Schema()
                    ...
                    Vendor = Add<__VVVeSchema__>("Vendor");
                    Vendor.SetCustomAccessors((_p_) => { return ((__VeVendorVo__)_p_).__bf__Vendor__; }, (_p_, _v_) => { ((__VeVendorVo__)_p_).__bf__Vendor__ = (__VVeVendorJs__)_v_; }, false);
                    ...
                    VENDOR_BALANCE.SetCustomAccessors((_p_) => { return ((__VeVendorVo__)_p_).__bf__VENDOR_BALANCE__; }, (_p_, _v_) => { ((__VeVendorVo__)_p_).__bf__VENDOR_BALANCE__ = (System.Decimal)_v_; }, false);
                    DATED = Add<__TString__>("DATED");
                    DATED.DefaultValue = "";
                    DATED.SetCustomAccessors((_p_) => { return ((__VeVendorVo__)_p_).__bf__DATED__; }, (_p_, _v_) => { ((__VeVendorVo__)_p_).__bf__DATED__ = (System.String)_v_; }, false);
...
#line default
        ...
        [_GEN1_][_GEN2_("Starcounter","2.0")]
        public __VVeVendorJs__ Vendor {
#line 7 "Server\Partials\VendorVoucherJson.json"
    get {
#line hidden
        return (__VVeVendorJs__)Template.Vendor.Getter(this); }
#line 7 "Server\Partials\VendorVoucherJson.json"
    set {
#line hidden
...
#line 9 "Server\Partials\VendorVoucherJson.json"
    get {
#line hidden
...
#line 12 "Server\Partials\VendorVoucherJson.json"
    get {
#line hidden
...
#line default
        ...
        public class VendorJson : __Json__ {
            #line hidden
            [_GEN2_("Starcounter","2.0")]
            public static __VVVeSchema__ DefaultTemplate = new __VVVeSchema__();
            [_GEN1_][_GEN2_("Starcounter","2.0")]
            public VendorJson() { }
            [_GEN1_][_GEN2_("Starcounter","2.0")]
            public VendorJson(__VVVeSchema__ template) { Template = template; }
            [_GEN1_][_GEN2_("Starcounter","2.0")]
            protected override _ScTemplate_ GetDefaultTemplate() { return DefaultTemplate; }
            [_GEN1_][_GEN2_("Starcounter","2.0")]
            public new __VVVeSchema__ Template { get { return (__VVVeSchema__)base.Template; } set { base.Template = value; } }
            public override bool IsCodegenerated { get { return true; } }
            private System.Int64 __bf__ID__;
            ...
            public static class JsonByExample {
                ...
                public class Schema : __TObject__ {
                    public Schema()
                        : base() {
                        InstanceType = typeof(__VVeVendorJs__);
                        ClassName = "VendorJson";
                        Properties.ClearExposed();
                        ID = Add<__TLong__>("ID");
                        ID.DefaultValue = 0L;
                        ID.SetCustomAccessors((_p_) => { return ((__VVeVendorJs__)_p_).__bf__ID__; }, (_p_, _v_) => { ((__VVeVendorJs__)_p_).__bf__ID__ = (System.Int64)_v_; }, false);
                        NAME = Add<__TString__>("NAME");
                        NAME.DefaultValue = "";
                        NAME.SetCustomAccessors((_p_) => { return ((__VVeVendorJs__)_p_).__bf__NAME__; }, (_p_, _v_) => { ((__VVeVendorJs__)_p_).__bf__NAME__ = (System.String)_v_; }, false);
                    }
                    public override object CreateInstance(s.Json parent) { return new __VVeVendorJs__(this) { Parent = parent }; }
                    public __TLong__ ID;
...
#line default
            ...
            public static class Input {
                ...
                #line hidden
                [_GEN1_][_GEN2_("Starcounter","2.0")]
                public class ID : Input<__VVeVendorJs__, __TLong__, long> {
                }
                #line default
                
                #line hidden
                [_GEN1_][_GEN2_("Starcounter","2.0")]
                public class NAME : Input<__VVeVendorJs__, __TString__, string> {
                }
                #line default
            }
            #line default
        ...
        public static class Input {
            ...
            #line hidden
            public class VENDOR_BALANCE : Input<__VeVendorVo__, __TDecimal__, Decimal> {
            }
            #line default
            
            #line hidden
            public class DATED : Input<__VeVendorVo__, __TString__, string> {
            }
            #line default
